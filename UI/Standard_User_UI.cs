...
{
    public partial class Standard_User_UI : Form
    {
        public Standard_User_UI()
        {
            InitializeComponent();
        }
        ...
        private void Standard_User_UI_Load(object sender, EventArgs e)
        {
        ...
        private void Standard_User_UI_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void syncBtn_Click(object sender, EventArgs e)
        {
            ...
            DataTable usersDataTable = generalLocalDatabase.selectNotOnlineData("users");
