...
{
    public partial class Transaction_Report_Details_UI : Form
    {
        public Transaction_Report_Details_UI()
        {
            InitializeComponent();
        }
        ...
        private void Transaction_Report_Details_UI_Load(object sender, EventArgs e)
        {
